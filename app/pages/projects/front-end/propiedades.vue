<template>
    <div class="container">
        ...
        <div class="prose prose-lg dark:prose-invert max-w-none" v-html="aboutProject.largeDescription">
        </div>
    </div>
...
const aboutProject = computed(() => ({
    ...
    largeDescription: t('projectsDev.propiedadesCancun.largeDescription')
}))
</script>
<style scoped>
.container {
