<template>
    <div class="container">
        ...
        <article class="max-w-4xl mx-auto px-4 py-8">
            ...
            <!-- Summary -->
            <section class="mb-10">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">{{ t('projectsDev.propiedadesCancun.caseStudy.labels.summary') }}</h2>
            ...
            <section v-if="caseStudy.stack && caseStudy.stack.length" class="mt-12 border-t border-gray-200 dark:border-gray-700 pt-8">
                <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-4">{{ t('projectsDev.propiedadesCancun.caseStudy.labels.stack') }}</h2>
...
useSeoMeta({
    title: () => t('projectsDev.propiedadesCancun.title'),
    titleTemplate: '%s | Isaac Quiroz Portfolio',
    description: () => t('projectsDev.propiedadesCancun.description'),
    keywords: ['bienes raíces', 'inmobiliaria', 'SEO técnico', 'rendimiento web', 'core web vitals', 'nuxt', 'nestjs', 'lighthouse', 'arquitectura frontend'],
    // Open Graph
    ogTitle: () => t('projectsDev.propiedadesCancun.title'),
    ogDescription: () => t('projectsDev.propiedadesCancun.description'),
    ogImage: 'https://isaacquirozmadrigal.dev/img/propiedades/nvifz5egnosguvd2tmgp.webp',
    ogUrl: 'https://isaacquirozmadrigal.dev/projects/front-end/propiedades',
    ogType: 'article',
    // Twitter Card
    twitterCard: 'summary_large_image',
    twitterTitle: () => t('projectsDev.propiedadesCancun.title'),
    twitterDescription: () => t('projectsDev.propiedadesCancun.description'),
...
const aboutProject = computed(() => ({
    projectType: t('projectsDev.propiedadesCancun.projectType'),
    contribution: t('projectsDev.propiedadesCancun.contribution'),
    myRole: t('projectsDev.propiedadesCancun.myRole'),
    timeline: t('projectsDev.propiedadesCancun.timeline'),
    title: t('projectsDev.propiedadesCancun.title'),
...
const caseStudy = computed(() => ({
    header: {
        title: t('projectsDev.propiedadesCancun.caseStudy.header.title'),
        subtitle: t('projectsDev.propiedadesCancun.caseStudy.header.subtitle')
    },
    summary: t('projectsDev.propiedadesCancun.caseStudy.summary'),
    results: resolveMessageDeep(tm('projectsDev.propiedadesCancun.caseStudy.results')),
    sections: resolveMessageDeep(tm('projectsDev.propiedadesCancun.caseStudy.sections')),
    stack: resolveMessageDeep(tm('projectsDev.propiedadesCancun.caseStudy.stack'))
}))
</script>
<style scoped>
.container {
