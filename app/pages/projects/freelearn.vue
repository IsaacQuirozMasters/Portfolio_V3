<template>
    <div class="container">
        ...
        <section class="grid grid-cols-1 md:grid-cols-[1fr,4fr] gap-4 md:gap-8 my-4">
            ...
            <section class="grid-2fr">
                <h3 class="text-xl text-gray-700 dark:text-gray-400">
                    Thanks to the internet, many people have access to education despite not having the possibility of
                    schooling, platforms like YouTube, blogs, etc.… help to create learning, however the difficulty in
                    finding precise information to what we are looking for or a guide from beginning to end on a general
                    topic like architecture, mechanics, chemistry among many, where reading, video, images are needed,
                    all this becomes difficult and the person when searching gets blocked spending a lot of time,
                    joining information from different platforms, that's why Free Learn was born, all the learning in a
                    single social network.
                </h3>
                <h3 class="text-2xl text-black-700 font-semibold mt-6">All in one</h3>
                <h3 class="text-xl text-gray-700 dark:text-gray-400">
                    <br>That's what Free Learn aims to offer</br>
                    <br>A space for learners to share their study guides, learning-related information, and where
                    teachers can share various types of information, text, images, videos, live streams, surveys,
                    learning groups and a personalized learning filter, this benefits a very important industry like
                    education and something lagging in the present.</br>
                </h3>
            </section>
        </section>
        ...
        <section class="grid grid-cols-1 md:grid-cols-[1fr,4fr] gap-4 md:gap-8 my-4">
            ...
            <section class="grid-2fr">
                <p class="text-sm text-gray-500 italic font-semibold my-2">
                    What is the point of exploring this solution? What user interactions are we talking about? Let's see
                    how users' usual behaviors and patterns can help apply these design concepts.
                </p>
                ...
                <p class="text-base text-gray-600 dark:text-white my-2">
                    We interviewed 10 people with usability questions, using the user empathy framework we were able to
                    understand their difficulties, common flow for learning and the flow for sharing information with
                    their team.
                </p>

                <h4 class="text-lg text-black-700 font-bold mt-4">Result</h4>
                <p class="text-base text-gray-600 dark:text-white my-2">
                    People who use YouTube to learn, also use Office Word for self-assessment, people who learn online
        ...
        <section class="grid grid-cols-1 md:grid-cols-[1fr,4fr] gap-4 md:gap-8 my-4">
            ...
            <section class="grid-2fr">
                <p class="text-base text-gray-600 dark:text-white my-2">
                    We decided to invest our effort mainly in the most used user flow, we discovered that it is finding
        ...
        <section class="grid grid-cols-1 md:grid-cols-[1fr,4fr] gap-4 md:gap-8 my-4">
            ...
            <section class="grid-2fr">
                <p class="text-base text-gray-600 dark:text-white my-2">
                    Taking into account the Information Architecture we started to arrange the corresponding elements in
                    their views, we expanded our range of possibilities with the Crazy Eight exercise and finally we
        ...
        <section class="grid grid-cols-1 md:grid-cols-[1fr,4fr] gap-4 md:gap-8 my-4">
            ...
            <section class="grid-2fr">
                <p class="text-base text-gray-600 dark:text-white my-2">
                    Having the wireframes ready on paper, we started to digitize them, giving each element a coordinate
                    on screen according to its hierarchy and weight, so that the user can be guided step by step through
                    the design to complete the main objective.
                </p>
            </section>
        </section>
        <NuxtImg format="webp" loading="lazy" sizes="100vw sm:100vw md:800px lg:1000px" quality="80"
        ...
        <section class="grid grid-cols-1 md:grid-cols-[1fr,4fr] gap-4 md:gap-8 my-4">
            ...
            <section class="grid-2fr">
                <p class="text-base text-gray-600 dark:text-white my-2">
                    Once the digital wireframes were created, we started to prototype, this helped us to know if our
        ...
        <section class="grid grid-cols-1 md:grid-cols-[1fr,4fr] gap-4 md:gap-8 my-4">
            ...
            <section class="grid-2fr">
                <p class="text-base text-gray-600 dark:text-white my-2">
                    We wanted to know how the user navigates between the views, how long it takes to access the
                    information, see their reactions when executing a task, all this was done during the Test Plan
                    process, the chosen participants were 6 people of different ages, professions and abilities.

                    During the interview we learned that the questions that the user failed to answer could contain
                    information from where it is mentioned on the card in order to be more accessible and consequently
                    save more interaction time.

                    We interpreted the Wireframe and solved the prompt
                </p>

                <h4 class="text-lg text-black-700 font-bold mt-4">📝 Design usability study study</h4>
                ...
                <ul class="list-disc space-y-2 mt-2 text-gray-600 dark:text-white">
                    <li> Could you briefly introduce yourself and tell me about your experience with technology and
...
const aboutProject = ref({
    ...
    myRole: 'UI/UX Generalist Designer',
    timeline: '1 month',
    title: 'Case Study Free Learn Website - English',
